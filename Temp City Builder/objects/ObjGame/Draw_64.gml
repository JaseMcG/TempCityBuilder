...
if(debugToggle == 1){
	...
	draw_text(x,y+d*0,"seed:" + string(random_get_seed()));
	draw_text(x,y+d*1,"gamespeed:" + string(global.GameSpeed));
	...
	if(instance_exists(ObjMenu)){
		...
		if(ObjMenu.gameStart == false){
			draw_text(x,y+d*2,"prevgamespeed:" + string(ObjMenu.prevGameSpeed));
